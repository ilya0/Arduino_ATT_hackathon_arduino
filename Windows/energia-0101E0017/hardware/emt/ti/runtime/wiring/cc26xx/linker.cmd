...
INPUT(
    ...
    lib/board.m3g.lib
    ti/runtime/driverlib/cc26xx/ti_drivers_lib/drivers_cc26xxware.am3g
    ti/runtime/heaps/lib/ti.runtime.heaps.am3g
    src/sysbios/sysbios.am3g
    ti/sysbios/fatfs/lib/release/ti.sysbios.fatfs.am3g
    ti/runtime/driverlib/cc26xx/lib/cc26xx.m3g.lib
...
INCLUDE "ti/platforms/emt26xx//include_gnu/CC2650_ROM.lds"
...
/* Content from ti.sysbios.rom.cortexm.cc26xx (ti/sysbios/rom/cortexm/cc26xx/golden/CC26xx/CC26xx_link_gnu.xdt): */
...
SECTIONS
{
    .rodata_xdc_runtime_Error_policy__C 0x0000058c : AT (0x0000058c) {*(.rodata_xdc_runtime_Error_policy__C)}
    .rodata_xdc_runtime_IModule_Interface__BASE__C 0x00000538 : AT (0x00000538) {*(.rodata_xdc_runtime_IModule_Interface__BASE__C)}
    .rodata_xdc_runtime_Startup_lastFxns__C 0x0000051c : AT (0x0000051c) {*(.rodata_xdc_runtime_Startup_lastFxns__C)}
    .rodata_ti_sysbios_gates_GateMutex_Object__DESC__C 0x00000310 : AT (0x00000310) {*(.rodata_ti_sysbios_gates_GateMutex_Object__DESC__C)}
    .rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_initDevice__I 0x000005ac : AT (0x000005ac) {*(.rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_initDevice__I)}
    .rodata_xdc_runtime_Startup_execImpl__C 0x0000054c : AT (0x0000054c) {*(.rodata_xdc_runtime_Startup_execImpl__C)}
    .rodata_ti_sysbios_gates_GateMutex_Instance_State_sem__O 0x000005cc : AT (0x000005cc) {*(.rodata_ti_sysbios_gates_GateMutex_Instance_State_sem__O)}
    .rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_getMaxTicks__E 0x000005a8 : AT (0x000005a8) {*(.rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_getMaxTicks__E)}
    .rodata_ti_sysbios_knl_Swi_Object__count__C 0x000004dc : AT (0x000004dc) {*(.rodata_ti_sysbios_knl_Swi_Object__count__C)}
    .rodata_ti_sysbios_knl_Idle_funcList__C 0x00000478 : AT (0x00000478) {*(.rodata_ti_sysbios_knl_Idle_funcList__C)}
    .rodata_ti_sysbios_family_arm_m3_Hwi_Object__PARAMS__C 0x00000170 : AT (0x00000170) {*(.rodata_ti_sysbios_family_arm_m3_Hwi_Object__PARAMS__C)}
    .rodata_xdc_runtime_Text_isLoaded__C 0x0000058a : AT (0x0000058a) {*(.rodata_xdc_runtime_Text_isLoaded__C)}
    .rodata_ti_sysbios_knl_Clock_Object__DESC__C 0x00000370 : AT (0x00000370) {*(.rodata_ti_sysbios_knl_Clock_Object__DESC__C)}
    .rodata_ti_sysbios_knl_Mailbox_Instance_State_dataQue__O 0x000005d4 : AT (0x000005d4) {*(.rodata_ti_sysbios_knl_Mailbox_Instance_State_dataQue__O)}
    .rodata_ti_sysbios_gates_GateMutex_Module__FXNS__C 0x00000240 : AT (0x00000240) {*(.rodata_ti_sysbios_gates_GateMutex_Module__FXNS__C)}
    .rodata_ti_sysbios_knl_Task_Module_State_inactiveQ__O 0x000005e8 : AT (0x000005e8) {*(.rodata_ti_sysbios_knl_Task_Module_State_inactiveQ__O)}
    .rodata_ti_sysbios_family_arm_m3_Hwi_Module__id__C 0x00000506 : AT (0x00000506) {*(.rodata_ti_sysbios_family_arm_m3_Hwi_Module__id__C)}
    .rodata_ti_sysbios_family_arm_cc26xx_Timer_Module__id__C 0x00000502 : AT (0x00000502) {*(.rodata_ti_sysbios_family_arm_cc26xx_Timer_Module__id__C)}
    .rodata_ti_sysbios_knl_Mailbox_Object__table__C 0x000004d0 : AT (0x000004d0) {*(.rodata_ti_sysbios_knl_Mailbox_Object__table__C)}
    .rodata_ti_sysbios_family_arm_m3_Hwi_Object__table__C 0x00000498 : AT (0x00000498) {*(.rodata_ti_sysbios_family_arm_m3_Hwi_Object__table__C)}
    .rodata_ti_sysbios_knl_Swi_Object__DESC__C 0x000003f0 : AT (0x000003f0) {*(.rodata_ti_sysbios_knl_Swi_Object__DESC__C)}
    .rodata_xdc_runtime_Text_charCnt__C 0x00000588 : AT (0x00000588) {*(.rodata_xdc_runtime_Text_charCnt__C)}
    .rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_start__E 0x000005b8 : AT (0x000005b8) {*(.rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_start__E)}
    .rodata_ti_sysbios_heaps_HeapMem_Object__table__C 0x000004c0 : AT (0x000004c0) {*(.rodata_ti_sysbios_heaps_HeapMem_Object__table__C)}
    .rodata_xdc_runtime_Error_policyFxn__C 0x0000052c : AT (0x0000052c) {*(.rodata_xdc_runtime_Error_policyFxn__C)}
    .rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_getCount64__E 0x000005a0 : AT (0x000005a0) {*(.rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_getCount64__E)}
    .rodata_xdc_runtime_Startup_firstFxns__C 0x00000514 : AT (0x00000514) {*(.rodata_xdc_runtime_Startup_firstFxns__C)}
    .rodata_ti_sysbios_knl_Swi_Object__PARAMS__C 0x000001f4 : AT (0x000001f4) {*(.rodata_ti_sysbios_knl_Swi_Object__PARAMS__C)}
    .rodata_ti_sysbios_knl_Clock_serviceMargin__C 0x000004c8 : AT (0x000004c8) {*(.rodata_ti_sysbios_knl_Clock_serviceMargin__C)}
    .rodata_xdc_runtime_Text_charTab__C 0x00000574 : AT (0x00000574) {*(.rodata_xdc_runtime_Text_charTab__C)}
    .rodata_ti_sysbios_rom_ROM_AONRTCCurrentCompareValueGet 0x00000598 : AT (0x00000598) {*(.rodata_ti_sysbios_rom_ROM_AONRTCCurrentCompareValueGet)}
    .rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_TimestampProvider_get32__E 0x000005bc : AT (0x000005bc) {*(.rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_TimestampProvider_get32__E)}
    .rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_getCurrentTick__E 0x000005a4 : AT (0x000005a4) {*(.rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_getCurrentTick__E)}
    .rodata_ti_sysbios_family_arm_m3_TaskSupport_stackAlignment__C 0x000004b0 : AT (0x000004b0) {*(.rodata_ti_sysbios_family_arm_m3_TaskSupport_stackAlignment__C)}
    .rodata_ti_sysbios_family_arm_m3_Hwi_NUM_INTERRUPTS__C 0x00000490 : AT (0x00000490) {*(.rodata_ti_sysbios_family_arm_m3_Hwi_NUM_INTERRUPTS__C)}
    .rodata_xdc_runtime_Main_Module__diagsMask__C 0x00000544 : AT (0x00000544) {*(.rodata_xdc_runtime_Main_Module__diagsMask__C)}
    .rodata_ti_sysbios_knl_Swi_Object__table__C 0x000004e0 : AT (0x000004e0) {*(.rodata_ti_sysbios_knl_Swi_Object__table__C)}
    .rodata_xdc_runtime_Memory_Module__id__C 0x00000586 : AT (0x00000586) {*(.rodata_xdc_runtime_Memory_Module__id__C)}
    .rodata_ti_sysbios_knl_Task_Object__PARAMS__C 0x00000100 : AT (0x00000100) {*(.rodata_ti_sysbios_knl_Task_Object__PARAMS__C)}
    .rodata_ti_sysbios_gates_GateMutex_Object__PARAMS__C 0x00000448 : AT (0x00000448) {*(.rodata_ti_sysbios_gates_GateMutex_Object__PARAMS__C)}
    .rodata_ti_sysbios_heaps_HeapMem_Module__gateObj__C 0x000004b8 : AT (0x000004b8) {*(.rodata_ti_sysbios_heaps_HeapMem_Module__gateObj__C)}
    .rodata_ti_sysbios_family_arm_cc26xx_Timer_startupNeeded__C 0x00000484 : AT (0x00000484) {*(.rodata_ti_sysbios_family_arm_cc26xx_Timer_startupNeeded__C)}
    .rodata_ti_sysbios_knl_Queue_Object__DESC__C 0x000003b0 : AT (0x000003b0) {*(.rodata_ti_sysbios_knl_Queue_Object__DESC__C)}
    .rodata_ti_sysbios_knl_Task_Object__DESC__C 0x00000410 : AT (0x00000410) {*(.rodata_ti_sysbios_knl_Task_Object__DESC__C)}
    .rodata_xdc_runtime_Assert_E_assertFailed__C 0x00000524 : AT (0x00000524) {*(.rodata_xdc_runtime_Assert_E_assertFailed__C)}
    .rodata_ti_sysbios_heaps_HeapMem_Object__PARAMS__C 0x00000264 : AT (0x00000264) {*(.rodata_ti_sysbios_heaps_HeapMem_Object__PARAMS__C)}
    .rodata_ti_sysbios_gates_GateHwi_Module__id__C 0x00000508 : AT (0x00000508) {*(.rodata_ti_sysbios_gates_GateHwi_Module__id__C)}
    .rodata_ti_sysbios_gates_GateHwi_Object__PARAMS__C 0x00000430 : AT (0x00000430) {*(.rodata_ti_sysbios_gates_GateHwi_Object__PARAMS__C)}
    .rodata_xdc_runtime_IHeap_Interface__BASE__C 0x00000534 : AT (0x00000534) {*(.rodata_xdc_runtime_IHeap_Interface__BASE__C)}
    .rodata_xdc_runtime_SysCallback_exitFxn__C 0x00000564 : AT (0x00000564) {*(.rodata_xdc_runtime_SysCallback_exitFxn__C)}
    .rodata_ti_sysbios_heaps_HeapMem_Module__id__C 0x0000050c : AT (0x0000050c) {*(.rodata_ti_sysbios_heaps_HeapMem_Module__id__C)}
    .rodata_ti_sysbios_family_arm_m3_Hwi_excHandlerFunc__C 0x000004a0 : AT (0x000004a0) {*(.rodata_ti_sysbios_family_arm_m3_Hwi_excHandlerFunc__C)}
    .rodata_ti_sysbios_heaps_HeapMem_Module__FXNS__C 0x000001cc : AT (0x000001cc) {*(.rodata_ti_sysbios_heaps_HeapMem_Module__FXNS__C)}
    .rodata_xdc_runtime_System_maxAtexitHandlers__C 0x00000570 : AT (0x00000570) {*(.rodata_xdc_runtime_System_maxAtexitHandlers__C)}
    .rodata_ti_sysbios_knl_Queue_Object__count__C 0x000004d4 : AT (0x000004d4) {*(.rodata_ti_sysbios_knl_Queue_Object__count__C)}
    .rodata_ti_sysbios_knl_Task_Object__table__C 0x000004ec : AT (0x000004ec) {*(.rodata_ti_sysbios_knl_Task_Object__table__C)}
    .rodata_ti_sysbios_knl_Mailbox_Object__DESC__C 0x00000390 : AT (0x00000390) {*(.rodata_ti_sysbios_knl_Mailbox_Object__DESC__C)}
    .rodata_ti_sysbios_family_arm_m3_Hwi_nullIsrFunc__C 0x000004a4 : AT (0x000004a4) {*(.rodata_ti_sysbios_family_arm_m3_Hwi_nullIsrFunc__C)}
    .rodata_ti_sysbios_knl_Clock_tickMode__C 0x00000510 : AT (0x00000510) {*(.rodata_ti_sysbios_knl_Clock_tickMode__C)}
    .rodata_ti_sysbios_gates_GateMutex_Module__id__C 0x0000050a : AT (0x0000050a) {*(.rodata_ti_sysbios_gates_GateMutex_Module__id__C)}
    .rodata_ti_sysbios_knl_Swi_numPriorities__C 0x000004e4 : AT (0x000004e4) {*(.rodata_ti_sysbios_knl_Swi_numPriorities__C)}
    .rodata_ti_sysbios_knl_Task_numConstructedTasks__C 0x000004fc : AT (0x000004fc) {*(.rodata_ti_sysbios_knl_Task_numConstructedTasks__C)}
    .rodata_xdc_runtime_Startup_maxPasses__C 0x00000550 : AT (0x00000550) {*(.rodata_xdc_runtime_Startup_maxPasses__C)}
    .rodata_ti_sysbios_rom_ROM_AONRTCEventClear 0x0000059c : AT (0x0000059c) {*(.rodata_ti_sysbios_rom_ROM_AONRTCEventClear)}
    .rodata_ti_sysbios_knl_Task_initStackFlag__C 0x0000050e : AT (0x0000050e) {*(.rodata_ti_sysbios_knl_Task_initStackFlag__C)}
    .rodata_xdc_runtime_Main_Module__diagsEnabled__C 0x0000053c : AT (0x0000053c) {*(.rodata_xdc_runtime_Main_Module__diagsEnabled__C)}
    .rodata_xdc_runtime_Main_Module__diagsIncluded__C 0x00000540 : AT (0x00000540) {*(.rodata_xdc_runtime_Main_Module__diagsIncluded__C)}
    .rodata_xdc_runtime_System_abortFxn__C 0x00000568 : AT (0x00000568) {*(.rodata_xdc_runtime_System_abortFxn__C)}
    .rodata_ti_sysbios_knl_Mailbox_Instance_State_dataSem__O 0x000005d8 : AT (0x000005d8) {*(.rodata_ti_sysbios_knl_Mailbox_Instance_State_dataSem__O)}
    .rodata_ti_sysbios_gates_GateHwi_Module__FXNS__C 0x0000021c : AT (0x0000021c) {*(.rodata_ti_sysbios_gates_GateHwi_Module__FXNS__C)}
    .rodata_ti_sysbios_hal_Hwi_Object__DESC__C 0x00000330 : AT (0x00000330) {*(.rodata_ti_sysbios_hal_Hwi_Object__DESC__C)}
    .rodata_ti_sysbios_family_arm_m3_Hwi_priGroup__C 0x000004ac : AT (0x000004ac) {*(.rodata_ti_sysbios_family_arm_m3_Hwi_priGroup__C)}
    .rodata_xdc_runtime_Error_E_memory__C 0x00000528 : AT (0x00000528) {*(.rodata_xdc_runtime_Error_E_memory__C)}
    .rodata_ti_sysbios_family_arm_m3_Hwi_E_alreadyDefined__C 0x00000488 : AT (0x00000488) {*(.rodata_ti_sysbios_family_arm_m3_Hwi_E_alreadyDefined__C)}
    .rodata_ti_sysbios_knl_Mailbox_Instance_State_freeSem__O 0x000005e0 : AT (0x000005e0) {*(.rodata_ti_sysbios_knl_Mailbox_Instance_State_freeSem__O)}
    .rodata_ti_sysbios_knl_Queue_Object__table__C 0x000004d8 : AT (0x000004d8) {*(.rodata_ti_sysbios_knl_Queue_Object__table__C)}
    .rodata_ti_sysbios_knl_Semaphore_Object__PARAMS__C 0x000002ac : AT (0x000002ac) {*(.rodata_ti_sysbios_knl_Semaphore_Object__PARAMS__C)}
    .rodata_xdc_runtime_System_exitFxn__C 0x0000056c : AT (0x0000056c) {*(.rodata_xdc_runtime_System_exitFxn__C)}
    .rodata_ti_sysbios_knl_Clock_Object__PARAMS__C 0x00000288 : AT (0x00000288) {*(.rodata_ti_sysbios_knl_Clock_Object__PARAMS__C)}
    .rodata_ti_sysbios_rom_ROM_AONRTCCompareValueSet 0x00000594 : AT (0x00000594) {*(.rodata_ti_sysbios_rom_ROM_AONRTCCompareValueSet)}
    .rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_setNextTick__E 0x000005b0 : AT (0x000005b0) {*(.rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_setNextTick__E)}
    .rodata_ti_sysbios_heaps_HeapMem_reqAlign__C 0x000004c4 : AT (0x000004c4) {*(.rodata_ti_sysbios_heaps_HeapMem_reqAlign__C)}
    .rodata_xdc_runtime_Main_Module__id__C 0x00000584 : AT (0x00000584) {*(.rodata_xdc_runtime_Main_Module__id__C)}
    .rodata_xdc_runtime_Startup_sfxnRts__C 0x00000554 : AT (0x00000554) {*(.rodata_xdc_runtime_Startup_sfxnRts__C)}
    .rodata_ti_sysbios_knl_Semaphore_Object__DESC__C 0x000003d0 : AT (0x000003d0) {*(.rodata_ti_sysbios_knl_Semaphore_Object__DESC__C)}
    .rodata_ti_sysbios_gates_GateHwi_Object__DESC__C 0x000002f0 : AT (0x000002f0) {*(.rodata_ti_sysbios_gates_GateHwi_Object__DESC__C)}
    .rodata_ti_sysbios_heaps_HeapMem_Object__count__C 0x000004bc : AT (0x000004bc) {*(.rodata_ti_sysbios_heaps_HeapMem_Object__count__C)}
    .rodata_ti_sysbios_family_arm_m3_Hwi_numSparseInterrupts__C 0x000004a8 : AT (0x000004a8) {*(.rodata_ti_sysbios_family_arm_m3_Hwi_numSparseInterrupts__C)}
    .rodata_ti_sysbios_family_arm_cc26xx_TimestampProvider_useClockTimer__C 0x00000504 : AT (0x00000504) {*(.rodata_ti_sysbios_family_arm_cc26xx_TimestampProvider_useClockTimer__C)}
    .rodata_ti_sysbios_rom_ROM_xdc_runtime_System_SupportProxy_exit__E 0x000005c8 : AT (0x000005c8) {*(.rodata_ti_sysbios_rom_ROM_xdc_runtime_System_SupportProxy_exit__E)}
    .rodata_ti_sysbios_knl_Queue_Object__PARAMS__C 0x00000460 : AT (0x00000460) {*(.rodata_ti_sysbios_knl_Queue_Object__PARAMS__C)}
    .rodata_ti_sysbios_knl_Task_allBlockedFunc__C 0x000004f0 : AT (0x000004f0) {*(.rodata_ti_sysbios_knl_Task_allBlockedFunc__C)}
    .rodata_ti_sysbios_rom_ROM_xdc_runtime_System_SupportProxy_abort__E 0x000005c4 : AT (0x000005c4) {*(.rodata_ti_sysbios_rom_ROM_xdc_runtime_System_SupportProxy_abort__E)}
    .rodata_ti_sysbios_knl_Mailbox_Object__count__C 0x000004cc : AT (0x000004cc) {*(.rodata_ti_sysbios_knl_Mailbox_Object__count__C)}
    .rodata_xdc_runtime_Text_nameStatic__C 0x0000057c : AT (0x0000057c) {*(.rodata_xdc_runtime_Text_nameStatic__C)}
    .rodata_ti_sysbios_rom_ROM_xdc_runtime_Startup_getState__I 0x000005c0 : AT (0x000005c0) {*(.rodata_ti_sysbios_rom_ROM_xdc_runtime_Startup_getState__I)}
    .rodata_ti_sysbios_knl_Clock_Module_State_clockQ__O 0x000005d0 : AT (0x000005d0) {*(.rodata_ti_sysbios_knl_Clock_Module_State_clockQ__O)}
    .rodata_ti_sysbios_knl_Task_defaultStackSize__C 0x000004f8 : AT (0x000004f8) {*(.rodata_ti_sysbios_knl_Task_defaultStackSize__C)}
    .rodata_xdc_runtime_IGateProvider_Interface__BASE__C 0x00000530 : AT (0x00000530) {*(.rodata_xdc_runtime_IGateProvider_Interface__BASE__C)}
    .rodata_ti_sysbios_family_arm_m3_Hwi_E_hwiLimitExceeded__C 0x0000048c : AT (0x0000048c) {*(.rodata_ti_sysbios_family_arm_m3_Hwi_E_hwiLimitExceeded__C)}
    .rodata_xdc_runtime_Startup_startModsFxn__C 0x0000055c : AT (0x0000055c) {*(.rodata_xdc_runtime_Startup_startModsFxn__C)}
    .rodata_ti_sysbios_knl_Semaphore_Instance_State_pendQ__O 0x000005e4 : AT (0x000005e4) {*(.rodata_ti_sysbios_knl_Semaphore_Instance_State_pendQ__O)}
    .rodata_ti_sysbios_family_arm_m3_Hwi_Object__DESC__C 0x000002d0 : AT (0x000002d0) {*(.rodata_ti_sysbios_family_arm_m3_Hwi_Object__DESC__C)}
    .rodata_xdc_runtime_Text_nameEmpty__C 0x00000578 : AT (0x00000578) {*(.rodata_xdc_runtime_Text_nameEmpty__C)}
    .rodata_ti_sysbios_family_arm_m3_Hwi_Object__count__C 0x00000494 : AT (0x00000494) {*(.rodata_ti_sysbios_family_arm_m3_Hwi_Object__count__C)}
    .rodata_xdc_runtime_SysCallback_abortFxn__C 0x00000560 : AT (0x00000560) {*(.rodata_xdc_runtime_SysCallback_abortFxn__C)}
    .rodata_ti_sysbios_knl_Task_defaultStackHeap__C 0x000004f4 : AT (0x000004f4) {*(.rodata_ti_sysbios_knl_Task_defaultStackHeap__C)}
    .rodata_ti_sysbios_family_arm_m3_Hwi_ccr__C 0x0000049c : AT (0x0000049c) {*(.rodata_ti_sysbios_family_arm_m3_Hwi_ccr__C)}
    .rodata_ti_sysbios_knl_Mailbox_Object__PARAMS__C 0x0000013c : AT (0x0000013c) {*(.rodata_ti_sysbios_knl_Mailbox_Object__PARAMS__C)}
    .rodata_ti_sysbios_hal_Hwi_Object__PARAMS__C 0x000001a0 : AT (0x000001a0) {*(.rodata_ti_sysbios_hal_Hwi_Object__PARAMS__C)}
    .rodata_ti_sysbios_heaps_HeapMem_E_memory__C 0x000004b4 : AT (0x000004b4) {*(.rodata_ti_sysbios_heaps_HeapMem_E_memory__C)}
    .rodata_ti_sysbios_knl_Task_Object__count__C 0x000004e8 : AT (0x000004e8) {*(.rodata_ti_sysbios_knl_Task_Object__count__C)}
    .rodata_ti_sysbios_rom_ROM_AONRTCChannelEnable 0x00000590 : AT (0x00000590) {*(.rodata_ti_sysbios_rom_ROM_AONRTCChannelEnable)}
    .rodata_ti_sysbios_heaps_HeapMem_Object__DESC__C 0x00000350 : AT (0x00000350) {*(.rodata_ti_sysbios_heaps_HeapMem_Object__DESC__C)}
    .rodata_xdc_runtime_Text_nameUnknown__C 0x00000580 : AT (0x00000580) {*(.rodata_xdc_runtime_Text_nameUnknown__C)}
    .rodata_xdc_runtime_Memory_defaultHeapInstance__C 0x00000548 : AT (0x00000548) {*(.rodata_xdc_runtime_Memory_defaultHeapInstance__C)}
    .rodata_ti_sysbios_knl_Mailbox_Instance_State_freeQue__O 0x000005dc : AT (0x000005dc) {*(.rodata_ti_sysbios_knl_Mailbox_Instance_State_freeQue__O)}
    .rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_setThreshold__I 0x000005b4 : AT (0x000005b4) {*(.rodata_ti_sysbios_rom_ROM_ti_sysbios_family_arm_cc26xx_Timer_setThreshold__I)}
    .rodata_xdc_runtime_Startup_sfxnTab__C 0x00000558 : AT (0x00000558) {*(.rodata_xdc_runtime_Startup_sfxnTab__C)}
